...
class EditResultForm(forms.Form):
    ...
    assignment_marks=forms.CharField(label="Sessional Marks",widget=forms.TextInput(attrs={"class":"form-control"}))
...
class UploadDoc(forms.ModelForm):
    file_path = forms.FileField(required=False)  # Define file_path field separately
    class Meta:
        model = Documentation
        fields = ['course_id', 'document_name', 'file_path', 'upload_date']
        widgets = {
